...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Parameter = __webpack_require__(180);
	...
	var Index = exports.Index = function (_React$Component) {
	  ...
	  _createClass(Index, [{
	    key: 'onEditParameter',
	    value: function onEditParameter(name, value) {
	      console.log('changeValue', name, value);
	    }
	  }, {
	    key: 'onInsertParameter',
	    value: function onInsertParameter(name, value) {
	      console.log('insert', name, value);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var onEditParameter = this.onEditParameter.bind(this);
	      var onInsertParameter = this.onInsertParameter.bind(this);
	      return _react2.default.createElement(_Parameter2.default, { parameters: requestParameters,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Editor = __webpack_require__(181);

	var _Editor2 = _interopRequireDefault(_Editor);

	var _Draft = __webpack_require__(182);
	...
	var Parameters = function (_React$Component) {
	  ...
	  function Parameters(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Parameters).call(this, props));
	  ...
	  _createClass(Parameters, [{
	    ...
	    key: 'onChanged',
	    value: function onChanged(name, value) {
	      this.props.onEditItem(name, value);
	    }
	  }, {
	    key: 'onDeleted',
	    value: function onDeleted(key) {
	      console.log('delete', key);
	    }
	  }, {
	    key: 'finishInsert',
	    value: function finishInsert(item) {
	      var _parameters = this.state.parameters;
	      var key = item.key;
	      if (!key) {
	        return;
	      }
	      ...
	      this.props.onInsertParameter(key, _parameters[key]);
	    }
	  }, {
	    key: 'insertItem',
	    ...
	    value: function render() {
	      ...
	      var onChanged = this.onChanged.bind(this);
	      var onDeleted = this.onDeleted.bind(this);
	      var finishInsert = this.finishInsert.bind(this);
	      var insertItem = this.insertItem.bind(this);
	      var rows = [];
	      Object.keys(this.state.parameters).forEach(function (k) {
	        var obj = _this2.state.parameters[k];
	        rows.push(_react2.default.createElement(_Editor2.default, { key: k, name: k, fileds: obj,
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            null,
	            this.state.draft && _react2.default.createElement(_Draft2.default, { finishInput: finishInsert, draft: this.state.draft }),
	            !this.state.draft && _react2.default.createElement(
	              'button',
	              { onClick: insertItem, className: 'btn' },
	...
	Parameters.propTypes = {
	  ...
	  onDeleted: _react2.default.PropTypes.func,
	  onInsertParameter: _react2.default.PropTypes.func
	};
	var parameterSpanStyle = {
	  borderTop: '0',
	  borderLeft: '0',
	  borderRight: '0',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Editor = function (_React$Component) {
	  ...
	  function Editor(props) {
	    ...
	    _this.state = {
	      value: _this.props.fileds.value,
	      comment: _this.props.fileds.comment,
	      must: _this.props.fileds.must,
	      delete: false
	    };
	    return _this;
	  }
	  ...
	  _createClass(Editor, [{
	    ...
	    value: function onChangeValue(e) {
	      ...
	      this.props.onChanged(this.props.name, state);
	    }
	  }, {
	    key: "onDeleteValue",
	    value: function onDeleteValue() {
	    ...
	    key: "render",
	    value: function render() {
	      var onChangeValue = this.onChangeValue.bind(this);
	      var onDeleteValue = this.onDeleteValue.bind(this);
	      return !this.state.delete && _react2.default.createElement(
	        "div",
	        null,
	        _react2.default.createElement(
	          "span",
	        ...
	        _react2.default.createElement("input", {
	          onChange: onChangeValue, style: parameterInputStyle,
	          name: "value", type: "text", className: "form-control",
	          placeholder: "value", defaultValue: this.state.value
	        }),
	        _react2.default.createElement("input", {
	          onChange: onChangeValue, style: parameterInputStyle,
	          name: "comment", type: "text", className: "form-control",
	          placeholder: "comment", defaultValue: this.state.comment
	        }),
	        _react2.default.createElement(
	          "button",
	          { onClick: onDeleteValue, className: "btn" },
	...
	Editor.propTypes = {
	  fileds: _react2.default.PropTypes.object,
	  onChanged: _react2.default.PropTypes.func,
	  onDeleted: _react2.default.PropTypes.func,
	  name: _react2.default.PropTypes.string
	};
	var parameterInputStyle = {
	  borderTop: '0',
	  borderLeft: '0',
	  borderRight: '0',
	  borderBottom: '1px soild #ccc',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Draft = function (_React$Component) {
	  ...
	  function Draft(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Draft).call(this, props));

	    _this.state = _this.props.draft;
	    return _this;
	  }

	  _createClass(Draft, [{
	    key: "onFormChange",
	    value: function onFormChange(_ref) {
	    ...
	    key: "finishInput",
	    value: function finishInput() {
	      this.props.finishInput(this.state);
	    }
	  }, {
	    key: "render",
	    value: function render() {
	      var onFormChange = this.onFormChange.bind(this);
	      var finishInput = this.finishInput.bind(this);
	      return _react2.default.createElement(
	        "div",
	        null,
	        _react2.default.createElement("input", {
	          onChange: onFormChange,
	          name: "key", type: "text", className: "form-control",
	          placeholder: "key", style: parameterInputStyle
	        }),
	        _react2.default.createElement("input", {
	          onChange: onFormChange,
	          name: "value", type: "text", className: "form-control",
	          placeholder: "value", style: parameterInputStyle
	        }),
	        _react2.default.createElement("input", {
	          onChange: onFormChange,
	          name: "comment", type: "text", className: "form-control",
	          placeholder: "comment", style: parameterInputStyle
	        }),
	        _react2.default.createElement(
	          "button",
	          { type: "button", className: "btn", onClick: finishInput },
	          "ok"
	        )
	      );
	    }
	...
	Draft.propTypes = {
	  draft: _react2.default.PropTypes.object,
	  finishInput: _react2.default.PropTypes.func
	};
	var parameterInputStyle = {
	  borderTop: '0',
	  borderLeft: '0',
